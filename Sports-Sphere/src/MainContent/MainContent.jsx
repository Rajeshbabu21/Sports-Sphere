...
function MainContent() {
  ...
  return (
    <div className='min-h-screen '>
      ...
      <div className='sm:mt-[50px] md:mt-[130px] mb-30 px-4 lg:mt-[130px]'>
        <h1 className='text-center text-[2.5rem] font-bold mb-4 head'>
          Dashboard
        </h1>
        ...
        <div className='grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
          {sports.map((sport, index) => (
            <div
              key={index}
              className='card border rounded-xl shadow-sm bg-card dark:border-neutral-700 dark:shadow-neutral-700/70 hover:shadow-lg mt-10 cursor-pointer'
